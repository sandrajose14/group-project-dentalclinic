...
function Homee() {
  ...
  return (
    <>
      <div style={{ width: '100%', minHeight: '100vh', backgroundColor: '#164863' }} >
        <div className="row">
          ...
          <div className="col-md-6 mt-3 ps-md-5 pt-3">
            <h1 className='text-light pt-5  '><FontAwesomeIcon icon={faTooth} size='xl' bounce style={{ color: "white", }} />  Dental Clinic</h1>
            <p className='p-3 text-light'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus, ipsum laborum excepturi quod reiciendis repellat distinctio cum eaque cupiditate, aperiam quisquam delectus nesciunt iusto perspiciatis et explicabo, natus facilis at. Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam cum minus expedita ex voluptatibus inventore molestiae quasi obcaecati ipsam dicta, ipsum ut consectetur tempora deserunt nulla debitis corrupti dolorum sequi. </p>
        ...
        {/* about section */}
        <section>
          <h1 className='text-center text-light mt-5'>About Us...</h1>
